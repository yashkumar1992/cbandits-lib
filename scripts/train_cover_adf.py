...
import numpy as np
from adapters.scratch.cover_adf import CoverADF

# --- Simulated Training Phase ---
model = CoverADF(ctx_dim=2, act_dim=2, cover_size=3, epsilon=0.05, psi=1.0)
...
model.save(name="cover_adf")

# --- Prediction Before Loading ---
new_model = CoverADF(ctx_dim=2, act_dim=2, cover_size=3)
