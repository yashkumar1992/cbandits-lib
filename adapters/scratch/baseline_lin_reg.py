...
class LinReg(CBModel):
    ...
    def save(self, registry_root="./artifacts/models", name = "lin_reg", version = "1.0", artifact_subpath = "models"):
    ...
    def load(self, registry_root="./artifacts/models", name = "lin_reg",version = "1.0", artifact_subpath = "models"):
        model_store = FSModelStore()
