...
import numpy as np
from adapters.scratch.regcb_opt import RegCBOpt

# --- Simulated Training Phase ---
model = RegCBOpt(ctx_dim=2, act_dim=2, alpha=1.0)
...
model.save(name="regcb_opt")

# --- Prediction Before Loading ---
new_model = RegCBOpt(ctx_dim=2, act_dim=2, alpha=1.0)
