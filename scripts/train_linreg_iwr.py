...
import numpy as np
from adapters.scratch.lin_reg_iwr import LinRegIWR



# --- Simulated Training Phase ---
model = LinRegIWR(ctx_dim=2, act_dim=2, learning_rate=0.1)
...
model.save(name="lr_iwr")

# --- Prediction Before Loading ---
new_model = LinRegIWR(ctx_dim=2, act_dim=2, learning_rate=0.1)
